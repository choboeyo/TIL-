...
//         if(i !== m - 1) {
//             // if(board[i][j] !== board[i][j + 1] ||  board[i][j] !== board[i + 1][j] || board[i][j] !== board[i + 1][j + 1]) break;
...
//                     copyBoard[i][j] = '0';
//                      copyBoard[i + 1][j + 1] = copyBoard[i - 1][j + 1];
//                     // copyBoard[i - 1][j + 1]  = '0';
//                     copyBoard[i][j+1] = '0';

//                 } else {
//                 copyBoard[i + 1][j] = copyBoard[i - 1][j];
//                 copyBoard[i - 1][j] = '0';
...
// // board [2][1]
// // board[3][1] = [board][1][1]
// // 만약 board[i - 1][j] 가 0일 경우 board[i + 1][j]는 board[3][1] = board [2][1]
// // board[2][1] = 0
